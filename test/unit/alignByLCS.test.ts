...
describe("alignDataArray", () => {
  ...
  it("有多个连续的共同元素:[1,2,3,4,5], [1,2,6,7]", () => {
    const result8 = alignByLCS([1, 2, 3, 4, 5], [1, 2, 6, 7]);
  ...
  it("有非连续的共同元素:[1,3,5,7], [2,3,4,7]", () => {
    const result9 = alignByLCS([1, 3, 5, 7], [2, 3, 4, 7]);
  ...
  it("对象数组测试1", () => {
    ...
    const result12 = alignByLCS(objArr1, objArr2, "id");
  ...
  it("对象数组测试3", () => {
    ...
    const result12 = alignByLCS(objArr1, objArr2);
    expect(result12[0]).toEqual([
      { id: 1, name: "张三" },
      { id: 2, name: "李四" },
      undefined,
  ...
  it("二维数组测试1: 修改", () => {
    ...
    const [alignData1, alignData2] = alignByLCS(data1, data2);
